        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <div class="mt-1">
                        <small id="phoneError" class="text-danger d-none">❌ Invalid phone number. It should be 10 digits starting with 079, 078, or 077.</small>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input name="age" type="number" id="age" class="form-control form-control-lg" min="1" max="120" required>
                    </div>
                
                    <!-- رسائل التحقق -->
                    <div class="mt-1">
                        <small id="ageError" class="text-danger d-none">❌ Please enter a valid age between 1 and 120.</small>
            ...
            <p class="text-center mt-3">Already have an account? <a href="{{ route('login') }}" class="text-login">Login</a></p>
        </form>
    </div>
