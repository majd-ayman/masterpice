            ...
            <div class="row" id="doctor-list">
                @foreach ($doctors as $doctor)
                    <div class="col-lg-4 doctor-card" data-clinic="{{ $doctor->clinic_id }}">
                        <div class="card mb-4">
                            <img src="{{ asset('images/team/' . $doctor->image) }}" class="card-img-top"
                                alt="Doctor Image" style="height: 350px; object-fit: cover;">
                            <div class="card-body text-center">
                                ...
                                <div class="rating">
                                    ...
                                    <div>
                                        ...
                                        {{-- mt-2 border-2 border-danger --}}

                                        <a href="/doctor/{{ $doctor->id }}"   class="btn btn-primary mt-2 border-2 border-success" >
                                            View Profile
                                        </a>
            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="cta-content">
                        ...
                        <a href="{{ route('appointment.form') }}" class="btn btn-main-2 btn-round-full">Get appoinment<i
